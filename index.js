...
function AddPlayerRow(Player)
{
    ...
    PercentagePenduCell.innerText = (Player.PercentagePendu).toPrecision(3)+"%";
    ...
    ScorePlusOuMoinsCell.innerText = Player.ScorePlusOuMoins;
    ...
    NimPercentageCell.innerText = (Player.PercentageNim).toPrecision(3)+"%";
    const TotalCell = document.createElement ("TD");
    TotalCell.innerText = (Player.Total).toPrecision(3);
